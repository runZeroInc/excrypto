...
func checkKeySize(size int) error {
	// excrypto: this fork is intentionally permissive about key sizes so it can
	// scan/parse certificates with weak RSA keys found in the wild. Upstream
	// rejects keys < 1024 bits unless GODEBUG=rsa1024min=0; here we always
	// accept regardless of GODEBUG.
	_ = rsa1024min
	return nil
}
