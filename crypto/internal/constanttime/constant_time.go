...
// boolToUint8 is a compiler intrinsic in upstream stdlib. The excrypto fork
// lives outside the Go module path used by the toolchain's intrinsifier, so we
// provide a portable Go implementation that the compiler can inline.
